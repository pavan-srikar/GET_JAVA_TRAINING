...
-- User table
INSERT INTO User (user_id, username, email, password, bio) VALUES
(1, 'Alice', 'alice@example.com', 'hashed_pass_1', 'Food lover and reviewer.'),
(2, 'Bob', 'bob@example.com', 'hashed_pass_2', 'Loves Italian food.'),
(3, 'Charlie', 'charlie@example.com', 'hashed_pass_3', 'Always looking for new places.'),
(4, 'Diana', 'diana@example.com', 'hashed_pass_4', 'Vegan and proud.'),
(5, 'Eve', 'eve@example.com', 'hashed_pass_5', 'Enjoys spicy food.');
